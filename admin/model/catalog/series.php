...
class ModelCatalogSeries extends Model {
	...
	public function editSeries($category_id, $data) {
	...
	public function deleteSeries($category_id) {
		$this->db->query("DELETE FROM " . DB_PREFIX . "category_path WHERE category_id = '" . (int)$category_id . "'");

		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "category_path WHERE path_id = '" . (int)$category_id . "'");

		foreach ($query->rows as $result) {
			$this->deleteSeries($result['category_id']);
		}
	...
	public function getSeries($category_id) {
	...
	public function getSeriesDescriptions($category_id) {
	...
	public function getSeriesStores($category_id) {
	...
	public function getSeriesSeoUrls($category_id) {
	...
	public function getSeriesLayouts($category_id) {

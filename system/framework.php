...
//查找关系类的文件路径
// $func = new ReflectionClass($response);
// echo $func->getFileName();

//所要查询的类名 echo $func->getFileName();
$response->addHeader('Content-Type: text/html; charset=utf-8');
$response->setCompression($config->get('config_compression'));
$registry->set('response', $response);
// echo $config->get('config_compression');
// Database
...
//查找关系类的文件路径
// $func = new ReflectionClass($route);
// echo $func->getFileName();
// Pre Actions
